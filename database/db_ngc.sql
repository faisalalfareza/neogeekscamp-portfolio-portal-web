...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Nov 2017 pada 07.52
...
--
ALTER TABLE `tbuser`
  MODIFY `UserId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;
--
-- AUTO_INCREMENT for table `tbuser_role`
--
ALTER TABLE `tbuser_role`
  MODIFY `UserRoleId` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
