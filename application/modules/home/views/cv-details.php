...
?>  
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item">
                                    <div class="portfolio-wrapper">
                                        <div class="portfolio-single">
                                            <div class="portfolio-thumb tags">
                                                <div class="thumb-caption">
                                                    <h4><?=$joinPro->ProName?></h4>
                                                    <?php
                                                      if($joinPro->ProStatus != 'finish'){
                                                    ?>      
                                                    ...
                                                    ?>
                                                    <h6 class="sites"><?=$joinPro->ProSites?></h6>
                                                    <p><?=$joinPro->ProDesc?></p>
                                                </div>
                                            </div>
                                            <div class="portfolio-view">   
                                                <ul class="nav nav-pills">
                                                    <li><a href="<?=site_url('home/project/projectDetails/'.$this->encrypt->encode($joinPro->ProId))?>">
    ...
    <?php $this->load->view('form/fresume'); ?>
