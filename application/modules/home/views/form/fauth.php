        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <img src="<?=base_img()."logo2.png"?>" width="50px" height="50px" alt="logo">
                ...
                <div class="modal-body">
                 <section class="modal-body">    
                  ...
                  <div class="popup_login user_login">
                    ...
                    <form action="<?php echo base_url()."auth/login"?>" method="post" id="formLogin" onsubmit="return false">
                     ...
                     <div class="action_btns">
                       ...
                       <div class="one_half last"><button type="submit" class="btn btn-success finishLogin" disabled>Log in</button></div>     
                     </div>
                   </form>
                  ...
                  <div class="popup_login user_register">
                    ...
                    <form action="<?php echo base_url()."auth/register" ?>" method="post" id="formRegister" onsubmit="return false">
                     <div class="form-group">
                       <label class="control-label" for="inputDefault">Email</label>
                     ...
                     <div class="action_btns">
                       ...
                       <div class="one_half last"><button type="submit" class="btn btn-success finishRegist" disabled>Register</button></div>     
                     </div>
                   </form>
                   <div class="centeredText ruleterms">
                     <span>By logging in, you agree to neogeekscamp's <a href="#">Terms of Service</a>, <a href="#">Cookie Policy</a>, <a href="#">Privacy Policy</a> and <a href="#">Content Policies</a>.</span>
                 ...
                 <div class="popup_login forgot">
                  <form action="<?php echo base_url()."auth/requestforget"?>" method="post" id="formRecover" onsubmit="return false">
                   <div class="form-group">
                     <label class="control-label" for="inputDefault">Email</label>
                   ...
                   <div class="action_btns">
                     ...
                     <div class="one_half last"><button type="submit" class="btn btn-success finishRecobery" disabled>Recover</button></div>
                   </div>
                  </form>
