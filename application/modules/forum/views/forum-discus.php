            ...
            <div class="container">    
               <div class="row">
                   ...
                   <div class="col-lg-12">
                    ...
                    <?php
                        $i = 0; $d = 0; 
                        foreach($forum as $getForumAndComment){
                    ...
                    <div class="well forum"> 
                      ...
                      <div class="forum-content">
                        ...
                        <h5><a class="comment" href="<?=site_url('forum/forumDetails/'.$this->encrypt->encode($getForumAndComment['ForumId']))?>">lihat komentar lain ..</a></h5>
